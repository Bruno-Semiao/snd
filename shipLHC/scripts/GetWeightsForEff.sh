...
#/afs/cern.ch/work/b/bcaetano/private/snd/sndsw/shipLHC/SimResults/
...
for d in $dir/*
{
        python /afs/cern.ch/work/b/bcaetano/private/snd/sndsw/shipLHC/scripts/UpdatedSurvey-MufiScifi.py -f "$d/sndLHC.Genie-TGeant4_digCPP.root" -c Internship -g "$d/geofile_full.Genie-TGeant4.root" -r -1 -i $d
}
